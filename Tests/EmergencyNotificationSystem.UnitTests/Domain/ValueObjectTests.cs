using EmergencyNotificationSystem.Domain.Models;

namespace EmergencyNotificationSystem.UnitTests.Domain
{
    public class ValueObjectTests
    {
        ...
        [Theory]
        [TestCaseSource(nameof(EqualValueObjects))]
        ...
        [Theory]
        [TestCaseSource(nameof(NonEqualValueObjects))]
        ...
        public static readonly object[] EqualValueObjects =
        {
            new object []
            {
                null,
        ...
        public static readonly object[] NonEqualValueObjects =
        {
            new object []
            {
