...
namespace EmergencyNotificationSystem.Infrastructure.Migrations
{
    ...
    [Migration("20240727190708_AddTable_UsersAndCompanies")]
    partial class AddTable_UsersAndCompanies
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UsersCompanies", b =>
                {
            ...
            modelBuilder.Entity("UsersCompanies", b =>
                {
                    b.HasOne("EmergencyNotificationSystem.Infrastructure.Entities.CompanyEntity", null)
                        .WithMany()
                        .HasForeignKey("CompaniesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EmergencyNotificationSystem.Infrastructure.Entities.UserEntity", null)
                        .WithMany()
